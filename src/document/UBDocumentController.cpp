...
void UBDocumentController::setupViews()
{
    ...
    if (!mDocumentWidget)
    {
        ...
        //connect(mDocumentUI->documentTreeView->itemDelegate(), SIGNAL(closeEditor(QWidget*,QAbstractItemDelegate::EndEditHint) ), mDocumentUI->documentTreeView, SLOT(adjustSize())); //change
